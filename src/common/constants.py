...
# ---------------------------------------------------------------------------
ETHERTYPE_AID = 0x1111  # Access Identifier packet  (per 任务书 §5.1)
ETHERTYPE_RID = 0x2222  # Route Identifier packet   (per 任务书 §5.1)
...
# ---------------------------------------------------------------------------
# RID packet header layout  (24 bytes) — per 任务书 §5.4 Fig.16
# ---------------------------------------------------------------------------
# Version(4b)+IDType(4b)=1B  QoS=1B  SpaceID=2B  PayloadLen=2B
# DataType=1B  TTL=1B  SrcRID=8B  DstRID=8B
# ---------------------------------------------------------------------------
RID_HEADER_BYTES = 24
